...
export function generateSchedulePrompt(schedule: any): string {
  ...
  { "2025-05-13 (화)": [  {순서 : 1, "start": "9:00",end:"11:00", "장소": "경주 탈해왕릉","위도": 35,"경도":36,주소:"", "타입": "관광지" } }, { 순서: 2, "시간": "11:00",end:"13:00", "장소": "오누이","위도": 35,"경도":36,주소:"", "타입": "음식점" } },이런 형태로 줘 숙소는 1박마다 머무를 곳이니까 이것도 위도 경도 포함해서 작성해주고 일정은 꽉꽉 채워서`;
